...
required_inputs:
  - A written model report (narrative covering split scheme, metric choice, baseline, diagnostics, leakage reasoning)
  - Optional: model card, diagnostic plots, code excerpts, or other supporting artifacts
tags:
  - data-analysis
  - audit
  - model-review
