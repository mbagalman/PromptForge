...
- [Coding workflow suite](development/coding-workflow-suite/README.md) — BRD → PRD → Tech Spec → ADR → Implementation Plan, with a workflow orchestrator and a forthcoming AGENTS.md generator (`development/`)
