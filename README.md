...
- [Data analysis prompts](data-analysis/README.md) — exploratory analysis, predictive modeling (XGBoost), audit of model reports, executive translation, and dashboard design (`data-analysis/`)
